...
def get_years_age(years):
    return subYears(date.today(),years)

def aYearAgo():
    return get_years_age(1)

def threeYearsAgo():
    return get_years_age(3)

def fiveYearsAgo():
    return get_years_age(5)

def tenYearsAgo():
    return get_years_age(10)

def twentyYearsAgo():
    return get_years_age(20)

def thirtyYearsAgo():
    return get_years_age(30)
