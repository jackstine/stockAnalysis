...
class CreateTables:
    ...
    def createIDSymbol(self):
        if (self.hasNoTable("IDSymbol")):
            self.mysql.commitExecute(str(self.table + "IDSymbol (id INT NOT NULL AUTO_INCREMENT," + self.symbolNotNull
                + " sector VARCHAR(70), industry VARCHAR(70), name "+ str(self.companyChar) + ",reference CHAR(1),  PRIMARY KEY (id))"))
    ...
    def createSplitHisotry(self):
        if (self.hasNoTable("SplitHistory")):
            self.mysql.commitExecute(str(self.table) + "SplitHistory (id INT, Date DATE, Ratio DECIMAL(12,5), PRIMARY KEY (id,Date))");
    ...
    def createGoogleFinancialCompletes(self):
        if (self.hasNoTable("GoogleFinancialCompletes")):
            self.mysql.commitExecute(self.table + "GoogleFinancialCompletes (" + self.id  + "tableName VARCHAR(50),DayExspectingQuarter DATE, Primary Key (id, tableName),"
                + self.foreignKeyID + ")")

    def createYahooFinancialCompletes(self):
        if (self.hasNoTable("YahooFinancialCompletes")):
            self.mysql.commitExecute(self.table + "YahooFinancialCompletes (" + self.id  + "tableName VARCHAR(50),DayExspectingQuarter DATE, Primary Key (id, tableName),"
                + self.foreignKeyID + ")")

    def createBloombergFinancialCompletes(self):
        if (self.hasNoTable("BloombergFinancialCompletes")):
            self.mysql.commitExecute(self.table + "BloombergFinancialCompletes (" + self.id  + "tableName VARCHAR(50), DayExspectingQuarter DATE, Primary Key (id, tableName),"
                + self.foreignKeyID + ")")

    def createNasdaqFinancialCompletes(self):
        if (self.hasNoTable("NasdaqFinancialCompletes")):
            self.mysql.commitExecute(self.table + "NasdaqFinancialCompletes (" + self.id  + "tableName VARCHAR(50), DayExspectingQuarter DATE,"
                + 'Primary Key (id, tableName),'+ self.foreignKeyID + ")")

    def createFinancialCompletes(self):
        if (self.hasNoTable("FinancialCompletes")):
            self.mysql.commitExecute(self.table + "FinancialCompletes (" + self.id  + "tableName VARCHAR(50), DayExspectingQuarter DATE,"
                + 'Primary Key (id, tableName),'+ self.foreignKeyID + ")")
    ...
    def createNasdaqSummaryQuote(self):
        if (self.hasNoTable("NasdaqSummaryQuote")):
            self.mysql.commitExecute(self.table + "NasdaqSummaryQuote (id INT, date DATE, quote DECIMAL(20,5), volume BIGINT,"
                + "low DECIMAL(20,5), high DECIMAL(20,2), outstandingShares BIGINT, PRIMARY KEY (id,Date), "
                + self.foreignKeyID + ")")
    ...
    def createNasdaqSymbolChanges(self):
        ...
        if (self.hasNoTable("NasdaqSymbolChanges")):
            self.mysql.commitExecute(self.table + "NasdaqSymbolChanges ( PreviousSymbol " + self.symbolChar + " NOT NULL, NewSymbol " + self.symbolChar
    ...
    def createNasdaqAcquisitions(self):
        ...
        if (self.hasNoTable("NasdaqAcquisitions")):
            self.mysql.commitExecute(self.table + "NasdaqAcquisitions ( Buyer VARCHAR(15), Bought VARCHAR(15), Date DATE,"
    ...
    def createChildrenStocks(self):
        ...
        if (self.hasNoTable("ChildrenStocks")):
            self.mysql.commitExecute(self.table + "ChildrenStocks (PrimaryStock VARCHAR(15), SecondaryStock VARCHAR(15), "
    ...
    def createNameChange(self):
        ...
        if (self.hasNoTable("NameChange")):
            self.mysql.commitExecute(self.table + "NameChange ("+ self.symbol +"date DATE, PreviousName VARCHAR(), NewName "
